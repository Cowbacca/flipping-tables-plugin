...
- Gradle **8.10**; Flipping Tables plugin **2.1.1**.
...
3. Set the hours until your next visit and the hours after that visit before newly bought stock should be sold (decimals such as `2.5` work), then set a budget no higher than the coins currently carried. Outstanding buy reserves are captured separately, so do not add them to this budget.
